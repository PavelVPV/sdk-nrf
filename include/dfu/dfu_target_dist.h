...
/** @file dfu_target_dist.h
 *
 * @defgroup dfu_target_ble_mesh Firmware update distributor target
 * @{
 * @brief DFU Target for distributing upgrades over other technologies.
 */

#ifndef dfu_target_dist_H__
#define dfu_target_dist_H__
 ...
 */
int dfu_target_dist_set_buf(uint8_t *buf, size_t len);
 ...
 */
bool dfu_target_dist_identify(const void *const buf);
 ...
 */
int dfu_target_dist_init(size_t file_size, int img_num, dfu_target_callback_t cb);
 ...
 */
int dfu_target_dist_offset_get(size_t *offset);
 ...
 */
int dfu_target_dist_write(const void *const buf, size_t len);
 ...
 * @return 0 on success, negative errno otherwise.
 */
int dfu_target_dist_done(bool successful);
 ...
 **/
int dfu_target_dist_schedule_update(int img_num);
 ...
 * @return 0 on success, negative errno otherwise.
 */
int dfu_target_dist_reset(void);
